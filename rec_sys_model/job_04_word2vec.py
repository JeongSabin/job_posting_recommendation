...
review_word = pd.read_csv('./rec_sys_model/wanted/clear_data/wanted_data_preprocessing_all.csv')
review_word.info()
...
embedding_model.save('./rec_sys_model/wanted/model/post_rec_model.model')
