...
def cosin_sim_calculation(category, url):
    ...
    Tfidf_matrix1 = mmread(f'/Library/work/python/job_posting_recommendation_last/rec_sys_model/wanted/TFIDF_model_welfare_/{category}_Tfidf_wanted_welfare.mtx').tocsr()
    Tfidf_matrix2 = mmread(f'/Library/work/python/job_posting_recommendation_last/rec_sys_model/wanted/TFIDF_model_work_/{category}_Tfidf_wanted_work.mtx').tocsr()
