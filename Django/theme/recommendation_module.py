...
def cosin_sim_calculation(category, url):
    ...
    Tfidf_matrix1 = mmread(f'D:/work/python/AI_exam_asia2204/job_posting_recommendation30/rec_sys_model/wanted/TFIDF_model_welfare_/{category}_Tfidf_wanted_welfare.mtx').tocsr()
    Tfidf_matrix2 = mmread(f'D:/work/python/AI_exam_asia2204/job_posting_recommendation30/rec_sys_model/wanted/TFIDF_model_work_/{category}_Tfidf_wanted_work.mtx').tocsr()
